...
export const products = [
    {
        title: "Dinosaur 01 T-Shirt",
        price: '159000',
        image01: product_01_image_01,
        image02: product_01_image_02,
        categorySlug: "ao-thun-polo-04",
        colors: ["white", "red", "orange"],
        slug: "ao-thun-dinosaur-01",
        size: ["s", "m", "l", "xl"],description:"The presence of basic crew-neck t-shirts in your wardrobe is the key to creating multiple stylish outfits without needing too many items. The women's basic cotton crew-neck t-shirt is a must-have for everyday wear"
    },
    {
        title: "Dinosaur 01 T-Shirt",
        price: '159000',
        ...
        size: ["s", "m"],
        description: "The PPN4502 t-shirt features a simple design and a comfortable fit. Why can just one basic women's t-shirt be styled in 10 different outfits? The answer lies in its simplicity. The simpler it is, the easier it is to mix and match with other pieces. The PPM4502 women's t-shirt has a classic crew-neck design that flatters the skin. The sleeves and fit are minimalistic and easy to wear for all body types. Additionally, the color options are elegant, neutral, and solid, making them easy to pair with different styles."
    },
    {
        title: "Dinosaur 01 T-Shirt",
        price: '190000',
